...
const PermissionDetailsForm: React.FC<any> = ({ initialData = {}, onSubmit, onCancel }) => {
                ...
                <button
                    ...
                    <button
                        ...
                        className={`w-full sm:w-auto text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline ${
                            initialData.permissionId ? 'bg-green-500 hover:bg-green-700' : 'bg-blue-500 hover:bg-violet-500'
                        }`}
                    >
                        {initialData.permissionId ? (
                            <>
