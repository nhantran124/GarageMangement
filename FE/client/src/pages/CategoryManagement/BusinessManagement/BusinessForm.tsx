...
const BusinessForm: React.FC<any> = ({ initialData = {}, onSubmit, onCancel }) => {
            ...
            <div className="space-y-4">
                <div className="flex flex-wrap -mx-2">
                    <div className="w-full px-2 mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="businessDetailsName">
                            Business Name 
                            {/* <span className="text-red-500">*</span> */}
                        </label>
                        <input
                            type="text"
                            {...register("businessDetailsName")}
                    ...
                    <div className="w-full px-2 mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="typeOfBusinessDetailsId">
                            ID Type Of Business
                        </label>
                        <input
                            type="text"
                            {...register("typeOfBusinessDetailsId")}
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div className="flex justify-end space-x-4 mt-4">
                    ...
                    <button
                        ...
                        className={`w-full sm:w-auto text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline ${
                            initialData.businessDetailsId ? 'bg-green-500 hover:bg-green-700' : 'bg-blue-500 hover:bg-violet-500'
                        }`}
                    >
                        {initialData.businessDetailsId ? (
                            <>
