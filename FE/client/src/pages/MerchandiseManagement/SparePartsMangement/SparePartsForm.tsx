...
const SparepartForm: React.FC<any> = ({ initialData = {}, onSubmit, onCancel }) => {
            ...
            <div className="space-y-4">
                <div className="flex flex-wrap -mx-2">
                    <div className="w-full px-2 mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="sparePartName">
                            Sparepart Name <span className="text-red-500">*</span>
                        </label>
                        <input
                            type="text"
                            {...register("sparePartName", { required: true })}
                    ...
                    <div className="w-full px-2 mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="sparePartContent">
                            Content 
                ...
                <button
                    ...
                    <button
                        ...
                        className={`w-full sm:w-auto text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline ${
                            initialData.sparePartId ? 'bg-green-500 hover:bg-green-700' : 'bg-blue-500 hover:bg-violet-500'
                        }`}
                    >
                        {initialData.sparePartId ? (
                            <>
